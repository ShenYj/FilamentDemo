...
- (void)initCommon {
    ...
    filament::Renderer::ClearOptions clearOptions = _renderer->getClearOptions();
...
- (void)loadModelGlb:(NSData*)buffer callback:(void(^_Nullable)())callback {
    [self destroyModel];
...
//        ResourceLoader::BufferDescriptor b(data.bytes, data.length, destroy, (void*)CFBridgingRetain(data));
